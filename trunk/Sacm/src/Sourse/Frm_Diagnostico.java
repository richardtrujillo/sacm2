...
private void dtf_idpacActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dtf_idpacActionPerformed
        desactivar();
        this.dtxf_desc.setEnabled(true);
        this.dtxf_desc.requestFocus();
}//GEN-LAST:event_dtf_idpacActionPerformed

private void dtf_idpacKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_dtf_idpacKeyTyped
 char numero=  evt.getKeyChar();
      if(!(numero>='0' && numero<='9'))
      {
          evt.consume();
      }
}//GEN-LAST:event_dtf_idpacKeyTyped
...
private void dtxf_descActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dtxf_descActionPerformed
     desactivar();
     this.dtxf_desc.setEnabled(true);
     this.dtxf_med.setEnabled(true);
     this.dtxf_med.requestFocus();
}//GEN-LAST:event_dtxf_descActionPerformed
